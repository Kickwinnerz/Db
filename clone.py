...
def _____oldx_____():
    ...
    print(""); linex()
    print(f"{white}<|●|> Cloning Complete Brother ")
    print(f'{white}<|●|> Total Ok >> '+str(len(ok)))
    print(f'{white}<|●|> Total Cp >> '+str(len(cp)))
    linex(); exit()
#---------------------------| Random Method 1 |---------------------------#
